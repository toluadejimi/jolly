...
<body>
					...
					<div class="install-item">
						...
						<div class="box-item">
							...
							?>
								...
								<div class="item">
									<h5 class="subtitle fw-bold">You Can:</h5>
									<ul class="check-list">
								...
								<div class="item">
									<h5 class="subtitle fw-bold">You Cannot: </h5>
									<ul class="check-list">
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 fw-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://viserlab.com/">ViserLab LLC</a></p>
		</div>
	</footer>
