    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="post">
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group">
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Customer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no one can register on this system as customer.')</small>
                                    </p>
                                </div>
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Guest Checkout')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no one can checkout as guest.')</small>
                                    </p>
                                </div>

                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="guest_checkout" @if (gs('guest_checkout')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Product Review Auto Approval')</p>
                                    <p class="mb-0">
                ...
                <button type="submit" class="btn btn--primary w-100 h-45 position-sticky bottom-0 mt-3">@lang('Submit')</button>
            </form>
        </div>
    </div>
@endsection
