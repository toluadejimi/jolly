            ...
            <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="text-center">
                    @if (request()->routeIs('product.detail'))
                        <h2 class="title"> @lang('PRODUCT NOT FOUND')</h2>
                    @else
                        <h2 class="title"> @lang('PAGE NOT FOUND')</h2>
                    @endif
                    <p class="description">
                        @if (request()->routeIs('product.detail'))
                            @lang('The product you are looking for doesn\'t exist, is temporarily unavailable, or has been permanently deleted.')
                        @else
                            @lang('The page you are looking for doesn\'t exist or another error occurred or temporarily unavailable.')
                        @endif
                    </p>
