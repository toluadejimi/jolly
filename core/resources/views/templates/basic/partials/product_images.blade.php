<div class="xzoom-container product-gallery">
    <img class="@if ($product->is_downloadable) downloadable_image @else xzoom5 @endif" id="xzoom-magnific" src="{{ $images->first()?->full_url ?? asset('assets/images/default.png') }}" xoriginal="{{ $images->first()?->full_url }}" />
    <div class="d-none">
