...
<div class="product-share">
    ...
    <a href="http://pinterest.com/pin/create/button/?url={{ urlencode(url()->current()) }}&description={{ __($product->name) }}&media={{ $product->mainImage() }}" title="@lang('Share on Pinterest')" target="blank">
