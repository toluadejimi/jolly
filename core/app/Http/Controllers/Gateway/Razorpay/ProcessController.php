...
class ProcessController extends Controller {
    ...
    public static function process($deposit) {
        ...
        $val['name'] =  $deposit->customer->fullname;
        $val['description'] = "Payment By Razorpay";
        $val['image'] = siteLogo();
        $val['prefill.name'] = $deposit->customer->fullname;
        $val['prefill.email'] = $deposit->customer->email;
        $val['prefill.contact'] = $deposit->customer->mobileNumber;
