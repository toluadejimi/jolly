...
class ProductListController extends Controller
{
    ...
    public function index()
    {
        ...
        $products  = Product::searchable(['name', 'slug'])
            ->filter(['is_published', 'brand_id', 'show_in_products_page', 'is_downloadable', 'product_type_id', 'product_type', 'is_published']);
        ...
        return view('admin.product.index', compact('pageTitle', 'products', 'trashed','columns'));
    }
